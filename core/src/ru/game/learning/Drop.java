...
public class Drop extends ApplicationAdapter {
    ...
    public void create() {
        ...
        bucket.x = 800 / 2 - 128 / 2; // center the bucket horizontally
    ...
    // скорость ведра увеличить в два раза
// скорость ведра увеличить в два раза
    @Override
    public void render() {
        ...
        batch.draw(player.texture, player.rectangle.x, player.rectangle.y, 64, 64);
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.SPACE)) {
            player.rectangle.y += 400 * Gdx.graphics.getDeltaTime();
        }
        if (player.rectangle.y >400){
            player.rectangle.y -= 400 * Gdx.graphics.getDeltaTime();
        }
        ...
        if (TimeUtils.nanoTime() - lastDropTime > 1000 * 1000000) spawnRaindrop();
